...
> This document is the public version of my learning plan. It tracks the
> skills I build, the resources I use, and the lessons I learn at each stage.
...
**Goal:** Build a solid base in the fundamentals of machine learning and deep learning.
...
**Takeaways:** I am comfortable with the ML workflow end-to-end. I understand the fundamentals of neural networks. I understand the transformer architecture at both a conceptual level and a practical level.

---

## 📚 Phase 2 — LLM Fundamentals

**Goal:** Understand how LLMs work in practice. Build reliable applications with LLMs.
...
**Topics I can now reason about:** why models hallucinate, gaps between the training data and the real data, context-window behavior, and how to measure if an LLM system works.

---

## 🔍 Phase 3 — RAG & Retrieval Systems *(in progress)*

**Goal:** Build retrieval-augmented systems. Learn to evaluate retrieval quality.
...
**Goal:** Understand fine-tuning as a design decision. Ship a complete application.
...
- **Fundamentals before frameworks** — understand the mechanism first, then use the tool.
- **Measure, do not assume** — every portfolio project has an evaluation section.
- **System design thinking** — consider latency, cost, reliability, and tradeoffs. Do not consider only features.
- **Domain focus** — this roadmap points the work at space and geospatial AI, the field I want to work in.
